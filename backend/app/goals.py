...
GOALS = {
    ...
    "objectives": [
        ...
        {"id": "quest", "priority": 2, "title": "Take and finish quests",
         "detail": "talk_to_npc to find work, accept_quest, hunt/turn_in_quest. "
                   "Quests are the fastest early XP and gold."},
    ...
    "starter_path": [
        ...
        "Move north to Oakhollow Forest; slay Giant Rats until 3/3, then take Scout Liora's q_wolfpack at level 2.",
        "Hurt? Return to town — every action there restores +5 HP for free.",
        "Turn in, buy a Healing Potion, then work the chain up: bandits in the capital (2+), trolls and wraiths (3+), the Ember Drake (5).",
