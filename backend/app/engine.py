...
ACTION_DEFS = [
    ...
    {"name": "accept_quest", "description": "Accept a quest offered by an NPC.", "cooldown_seconds": 2,
     "params": {"quest_id": "string"}},
    {"name": "turn_in_quest", "description": "Turn in a completed quest to its giver.", "cooldown_seconds": 2,
     "params": {"quest_id": "string"}},
